...
public class BreadthFirstPaths {
    ...
    /**
     * Computes the shortest path between <tt>s</tt> and every other vertex in graph <tt>G</tt>.
     * @param G the graph
    ...
    /**
     * Is there a path between the source <tt>s</tt> (or sources) and vertex <tt>v</tt>?
     * @param v the vertex
    ...
    /**
     * Returns the number of edges in a shortest path between the source <tt>s</tt>
    ...
    /**
     * Returns a shortest path between <tt>s</tt> (or sources) and <tt>v</tt>, or
